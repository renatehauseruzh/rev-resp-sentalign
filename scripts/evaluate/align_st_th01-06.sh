...
python3 $alignment/align.py $data/goldstandard/rev-resp-goldstandard_empty_115.csv $evaluation/st_para_th01.json --threshold 0.1 --scoring "sentence embedding" --model "sentence-transformers/nli-mpnet-base-v2"

python3 $alignment/align.py $data/goldstandard/rev-resp-goldstandard_empty_115.csv $evaluation/st_para_th02.json --threshold 0.2 --scoring "sentence embedding" --model "sentence-transformers/nli-mpnet-base-v2"

python3 $alignment/align.py $data/goldstandard/rev-resp-goldstandard_empty_115.csv $evaluation/st_para_th03.json --threshold 0.3 --scoring "sentence embedding" --model "sentence-transformers/nli-mpnet-base-v2"

python3 $alignment/align.py $data/goldstandard/rev-resp-goldstandard_empty_115.csv $evaluation/st_para_th04.json --threshold 0.4 --scoring "sentence embedding" --model "sentence-transformers/nli-mpnet-base-v2"

python3 $alignment/align.py $data/goldstandard/rev-resp-goldstandard_empty_115.csv $evaluation/st_para_th05.json --threshold 0.5 --scoring "sentence embedding" --model "sentence-transformers/nli-mpnet-base-v2"

python3 $alignment/align.py $data/goldstandard/rev-resp-goldstandard_empty_115.csv $evaluation/st_para_th06.json --threshold 0.6 --scoring "sentence embedding" --model "sentence-transformers/nli-mpnet-base-v2"